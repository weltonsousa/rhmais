                            ...
                            <div class="row" style="width:960px; margin: 0 auto;">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                    <select class="form-control has-feedback-left" name="nacionalidade">
                                        <option value="{{ $estagiario->nacionalidade }}">
                                            {{ $estagiario->nacionalidade }}
                                        </option>
                            ...
                            <div class="row" style="width:960px; margin: 20px auto;">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="password" class="form-control has-feedback-left"
                                        placeholder="Criar Senha" name="senha" value="{{ $estagiario->senha }}">
                                    <span class="fa fa-key form-control-feedback left" aria-hidden="true"></span>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <textarea class="form-control" placeholder="Sua observação" name="obs"
                                        value="{{ $estagiario->obs }}">{{ $estagiario->obs }}</textarea>
                                </div>
