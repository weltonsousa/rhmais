                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="tLista" style="padding-top: 16px;" class="stripe">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td class="mini-title upper">Custo Unitário</td>
                        ...
                        <div id="lateral" class="suave">
                            ...
                            <h4 class="barlow">Cadastrar Empresa<i class="material-icons click suave fechar">close</i></h4>
                            <form id="form-criar" method="POST">
                                <div class="tab">
                                    ...
                                    <div class="metade esquerda">
                                        <label>Empresa</label>
                                        <input type="text" placeholder="empresa" name="nome_fantasia" id="nome_fantasia" oninput="this.className = ' ' ">
                                    </div>
                                    <div class="metade direita">
                                 ...
                                 <div class="metade direita">
                                    <label>Celular</label>
                                    <input type="text" placeholder="Celular" name="telefone" id="telefone" class="telefone" oninput="this.className = ' ' ">
                                </div>
                                </div>
                                 <div class="clear"></div>
                                {{-- Etapa 2 --}}
                                ...
                                <div class="tab">
                                    <div class="metade esquerda">
                                    <label>Dia p/ Pgto Estágiario(a)</label>
                                    <input type="text" placeholder="Dia p/ Pgto Estágiario(a)" name="data_estagiario" id="data_estagiario" maxlength="2" oninput="this.className = ' ' ">
                                </div>
                                 <div class="metade direita">
                                    <label>Dia p/ Vcto Boleto</label>
                                    <input type="text" placeholder="Dia p/ Vcto Boleto" name="data_boleto" id="data_boleto" maxlength="2" oninput="this.className = ' ' ">
                                </div>
                                  <div class="clear"></div>
                                 <div class="metade direita">
                                    <label>Dia p/ Fechamento</label>
                                    <input type="text" placeholder="Dia p/ Fechamento" name="data_fechamento" id="data_fechamento" maxlength="2" oninput="this.className = ' ' ">
                                </div>
                                 <div class="metade esquerda">
                                    <label>Custo unitário</label>
                                    <input type="text" placeholder="Custo unitário" name="custo_unitario" id="custo_unitario" oninput="this.className = ' ' ">
                                </div>
                                 <div class="clear"></div>
                                {{-- <div class="checkbox-round"> --}}
                                <div class="metade direita">
                                    <label>
                                      <input type="checkbox"> Proporcional
                                    </label>
                                </div>
                                <div class="metade esquerda">
                                    <label>
                                      <input type="checkbox" value="1" name="ativo"> Está Ativo
                                    </label>
                                </div>
                                 <div class="clear"></div>
                                <div class="metade direita">
                                    <label>
                                      <input type="checkbox"> Dias Comerciais
                                    </label>
                                </div>
                                <div class="metade esquerda">
                                    <label>
                                      <input type="checkbox"> Roda Folha
                                    </label>
                                {{-- </div> --}}
                                </div>
                                </div>
                            ...
                            <div id="editar" class="content suave">
                                ...
                                <div class="e_tab">
                                        <input type="hidden" name="e_id_empresa" id="e_id_empresa" value="">
                                    <div class="metade esquerda">
                                        <label>CNPJ</label>
                                    ...
                                    <div class="metade esquerda">
                                        <label>Empresa</label>
                                        <input type="text" placeholder="empresa" name="e_nome_fantasia" id="e_nome_fantasia" oninput="this.className = ' ' ">
                                    </div>
                                    <div class="metade direita">
                                        <label>Telefone</label>
                                ...
                                <div class="metade esquerda">
                                 ...
                                 <div class="clear"></div>
                                    <div class="metade esquerda">
                                    <label>Dia Pgto Estágiario(a)</label>
                                    <input type="text" placeholder="Dia Pgto Estágiario(a)" name="e_data_estagiario" id="e_data_estagiario" maxlength="2" oninput="this.className = ' ' ">
                                </div>
                                 <div class="metade direita">
                                    <label>Dia p/ Vcto Boleto</label>
                                    <input type="text" placeholder="Dia p/ Vcto Boleto" name="e_data_boleto" id="e_data_boleto" maxlength="2" oninput="this.className = ' ' ">
                                </div>
                                  <div class="clear"></div>
                                 <div class="metade esquerda">
                                    <label>Dia p/ Fechamento</label>
                                    <input type="text" placeholder="Dia p/ Fechamento" name="e_data_fechamento" id="e_data_fechamento" maxlength="2" oninput="this.className = ' ' ">
                                </div>
                                 <div class="metade direita">
                                    <label>Custo unitário</label>
                                    <input type="text" placeholder="Custo unitário" name="e_custo_unitario" id="e_custo_unitario" oninput="this.className = ' ' ">
                                </div>
                                   <div class="clear"></div>
                                {{-- <div class="checkbox-round"> --}}
                                <div class="metade esquerda">
                                ...
                                <div class="metade direita">
                                    <label>
                                      <input type="checkbox"  name="e_ativo" id="e_ativo"> Está Ativo
                                    </label>
                                </div>
                                 <div class="clear"></div>
                                <div class="metade esquerda">
...
<script>
    ...
    function carregar(){
        table = $('#tLista').DataTable({
            ...
            columns: [
                {data: 'id_empresa', width: "60px", className: 'dt-body-center dt-head-center'},
                {data: 'nome_fantasia', width: "400px"},
                {data: 'cidade', width: "200px", className: 'dt-body-center dt-head-center'},
                {data: 'telefone', width: "200px", className: 'dt-body-center dt-head-center'},
                ...
                {data: null, width: "200px", className: 'dt-body-center dt-head-center',
                  render: function ( data, type, row ) {
                            return parseInt(row.custo_unitario).toLocaleString('pt-BR', {style: 'currency', currency: 'BRL'});
                        }
                },
                {data: null, width: "200px", className: 'dt-body-center dt-head-center',
                    render: function(data, type, row){
         ...
         $(document).on("click", ".editar", function(){
            ...
            $("#editar #e_id_empresa").val(data.id_empresa);
            consultar(data.id_empresa);
        });
        var delete_id;
    ...
    $(".criar").click(function(){
        ...
        function criar(){
            ...
            request.done(function(response){
                if(response == "1"){
                    ...
                    criaAlerta(0, "Empresa criado!",5000);
                    recarregar();
                }
            });
        }
        ...
        function consultar(id){
            ...
            request.done(function(response){
                $('#form-editar input[name="e_id_empresa"]').val(response.id_empresa);
                $('#form-editar input[name="e_cnpj"]').val(response.cnpj);
                $('#form-editar input[name="e_nome_fantasia"]').val(response.nome_fantasia);
                ...
                $('#form-editar input[name="e_custo_unitario"]').val(response.custo_unitario);
                ...
                $('#form-editar input[name="e_data_estagiario"]').val(response.data_estagiario);
                $('#form-editar input[name="e_data_boleto"]').val(response.data_boleto);
                $('#form-editar input[name="e_data_fechamento"]').val(response.data_fechamento);
        ...
        function editar(){
            ...
            request.done(function(response){
                if(response == "2"){
                    ...
                    criaAlerta(0, "Empresa atualizado!",5000);
                    recarregar();
                }
            });
        }
        ...
        function deletar(id){
            ...
            request.done(function(response){
                if(response == "1"){
                    ...
                    $("#alerta p").text("Empresa deletado!");
